...
function PortfolioDetail({ data }) {
  if (data === null) {
    return (
      <section style={{ marginTop: "400px" }} className="container mx-auto">
  ...
  return (
    <section style={{ marginTop: "150px" }} className="container mx-auto">
      <Fade bottom>
        <Button
          type="link"
          href="/project"
          className="flex w-40 h-8 text-lg items-center ml-6 sm:ml-20 mt-8 font-light text-black hover:underline"
        >
          <svg
      ...
      {data.map((item) => (
        <div className="flex flex-col mt-8 justify-center">
          <Fade bottom triggerOnce>
            ...
            <p className="font-light text-xl text-black text-center mb-10">
              {item.type}
            </p>
          </Fade>
          ...
          <Fade bottom delay={300 * 1} triggerOnce>
            <div className="flex flex-col mt-16 mb-12 mx-8 sm:mx-16 xl:mx-28">
              ...
              <p className="font-light text-lg text-black text-justify">
            ...
            <p className="font-light italic text-black mt-16 mx-8 sm:mx-16 xl:mx-28">
